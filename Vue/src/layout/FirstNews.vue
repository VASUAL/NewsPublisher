        ...
        <template #default="scope" class="el1">
          <table class="el1">
            <tr class="tr1">
              ...
              <td class="el1">{{scope.row.date}}</td>
              <td class="el1">{{scope.row.click}}&nbsp;&nbsp;浏览</td>
            </tr>
          </table>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    //加载数据
    loadData() {
      request.post("/news/getFirstNews").then(res =>{
...
.l4{
  position: absolute;transform: translate(-50%,-50%);left: 63.75%;top: 50%;color: #409eff;font-size: 17px;
}
.l5{
